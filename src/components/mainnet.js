...
export default class setseller extends React.Component {
    ...
    async fetchContractData() {
        ...
        this.countBettorsInCycle(
            storagedata.data.value.cycleOperations[withdrawcycle].rangeDetails
        );
        const price = parseInt(
            storagedata.data.value.cycleOperations[withdrawcycle.toString()]
                .priceAtCurrentCycle
        );
    ...
    async betting() {
        try {
            ...
            if (this.state.amount > 10) {
                throw new Error('Sorry you cannot stake more than 10 xtz');
            }
            if (this.state.amount == null) {
                amountInRange = 1;
            } else {
                    ...
                    <Container fluid="xs" align="left">
                        ...
                        >
                            ...
                            <li style={{ 'padding-bottom': '1vmax' }}>
                                ...
                                {this.state.spranges[i][2] ==
                                this.state.spranges[i][3]
                        ...
                        >
                            *The mentioned ROI is only applicable if your
                            prediction is right.Else your ROI would be 0%.
                            <br />
                            ** The maximum expected ROI is variable under the
                            cycle and is dependent on the total number of XTZ
                            staked on the other price ranges and the outcome of
            ...
            if (val) {
                ...
                const sell = await tezos.wallet.at(
                    'KT1DGHWbNCa57L9ctZXrD45P3XoDsHXAdgJK'
                );
            ...
            >
                ...
                >
                    ...
                    >
                        <Collapse
                            isOpen={
                                this.state.error || this.state.warningBarOpen
                            }
                        >
                        ...
                        >
                            ...
                            >
                                <Col xs="6">
                                    ...
                                    >
                                        Current Cycle {this.state.currentCycle}{' '}
                ...
                <Container
                    ...
                    style={{
                        ...
                        'padding-top': '5vmax',
                        'padding-bottom':
                            this.state.help || this.state.option
                                ? '3.3333333vmax'
                                : '5vmax',
                    }}
                >
                    ...
                    >
                        You can search for more details by clicking on the
                                    ...
                                    <CardBody>
                                        <CardText>
                                            ...
                                            >
                                                ...
                                                >
                                                    The Expected ROI currently
                                                    for your inputted staking
                                                    amount is{' '}
                                                    {this.state
                                                        .tamountInRange ==
                                                    this.state.spranges[
                                                ...
                                                >
                                                    ...
                                                    back your returns along with
                                                    your staking
                                                    betAmountment.Else you would
                                                    lose your staking returns
                                                    and only get back your
