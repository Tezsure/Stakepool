...
export default class setseller extends React.Component {
    ...
    async fetchCycleData() {
        ...
        const tzresponse = await axios.get(
            'https://api.carthagenet.tzstats.com/explorer/cycle/head/'
        );
    ...
    async fetchContractData() {
        const storagedata = await axios.get(
            'https://api.better-call.dev/v1/contract/carthagenet/KT18of9Q7f2UKfPteTTDYHGN9uUZes4Em6ha/storage/rich'
        );
        const l = storagedata.data.args[0].args[1].args[1].length;
        const mapdata =
            storagedata.data.args[0].args[1].args[1][l - 1].args[1].args[0];
        const price =
            storagedata.data.args[0].args[1].args[1][l - 1].args[1].args[1]
                .args[1].int;
        const rate =
            parseInt(storagedata.data.args[1].args[1].args[0].int) / 100;
        ...
        if (this.state.tamountInRange != tamount) {
            ...
            for (i in mapdata) {
                ...
                lRange =
                    (parseInt(price) +
                        parseInt(
                            (price * mapdata[i].args[0].args[0].int) / 10000
                        )) /
                    100;
                uRange =
                    (parseInt(price) +
                        parseInt(
                            (price * mapdata[i].args[0].args[1].int) / 10000
                        )) /
                    100;
                sprange = [
                    lRange,
    ...
    async betting() {
        try {
            ...
            alert(
                'Your transaction has been successful and will be considered for staking from the following cycle onwards'
            );
    ...
    render() {
        return (
            <div style={{ backgroundColor: '#FFFFFF', height: '100vh' }}>
                    ...
                    <div style={{ backgroundColor: '#6b747b' }}>
                        ...
                        <p
                            ...
                            style={{
                                ...
                                padding: '0em 0em 0em 32em',
                            }}
                        >
                            <strong>
                                <em>~Earn extra on your staking rewards</em>
                            </strong>
                        </p>
                    </div>
                    <div style={{ backgroundColor: '#39cb90' }}>
                        ...
                        >
                            ...
                            <Row xs="2">
                                <Col style={{ 'text-align': 'left' }}>
                                    <label style={{ 'font-size': '1.125em' }}>
                                        <strong>
                                            The Current Cycle{' '}
                                            {this.state.currentCycle} will be
                                            concluded in:
                                        </strong>{' '}
                                    </label>
                                </Col>
                                ...
                                >
                                    <output style={{ 'font-size': '1em' }}>
                                        <em>${this.state.currentprice}</em>
                                    </output>
                                </Col>
                            </Row>
                        </div>
                ...
                <label style={{ 'font-size': '1.5em', color: '#0b281c' }}>
                    &nbsp;&nbsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;I
                    want to stake:{' '}
                </label>
                <label style={{ 'font-size': '1.5em', color: '#0b281c' }}>
                    &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;I
                    predict the price of XTZ to be:{' '}
                </label>
                <br />
                <InputGroup>
                        ...
                        onChange={(eve) => {
                            if (Number(eve.target.value) != 0) {
                                this.setState({
                                    amount:
                                        Math.round(
                                            Number(eve.target.value) * 1000000
                                        ) / 1000000,
                                });
                            }
                        }}
                    ...
                    <InputGroupAddon addonType="append">
                        <InputGroupText style={{ color: 'dodgerblue' }}>
                            XTZ
                        </InputGroupText>
                    </InputGroupAddon>
                    &emsp;&nbsp;
                    ...
                    >
                        Select a predicted price range of XTZ on the completion
                    ...
                    <Input
                        ...
                        style={{ 'text-align': 'center', width: '3.9cm' }}
                    >
                                    ...
                                    >
                                        <CardBody>
                                            ...
                                            <CardText>
                                                <ul>
                                                    <li>
                                                        The Current ROI for your
                                                        inputted staking amount
                                                        is{' '}
                                                        {this.state
                                                            .tamountInRange ==
                                                        this.state.spranges[
                                                    ...
                                                    <br />
                                                    <li>
                                                        A fee of 2% inclusive on
                                                        your winning returns is
                                                        taken for the usage of
                                                        the platform.
                                                    </li>
                                                    <br />
                                                    <li>
                                                        If at the completion of
                                                        your staking period on{' '}
                                                        {new Date(
                                                            this.state
                                                                .cycletime +
                                                                this.state
                                                        ...
                                                        , the price of Xtz is in
                                                        this range, then you get
                                                        back your returns along
                                                        with your staking
                                                        betAmountment.Else you
                                                        would lose your staking
                                                        returns and only get
                                                        back your staking
                                                        betAmountment.{' '}
                                                    </li>
                                                    <br />
                                                    <li>
                                                        You shall get back your
                                                        staked amount (plus the
                                                        winning rewards if
                                                        applicable) at the
                                                        conclusion of cycle{' '}
                                                        {this.state.endCycle +
