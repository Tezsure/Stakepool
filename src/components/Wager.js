...
export default class setbuyer extends React.Component {
    ...
    async buying() {
        try {
            ...
            const wallet = new TempleWallet('Staking Market');
            const connect = await wallet.connect('carthagenet', {
            ...
            const buy = await tezos.wallet.at(
                'KT1FTfe28g6sgEsQ75MA8J6WHRdV9w5oit1b'
            );
            const operation = await buy.methods
                .setBuyer(strikeprice)
            ...
            <div className="mainContainer">
                ...
                <div align="right">
                    <label style={{ 'font-size': '18px' }}>
                        <strong>Current price of XTZ/USD:</strong>{' '}
                    </label>
                ...
                <label>
                    &emsp;&emsp;&emsp;Enter the price you estimate XTZ/USD will
                    fall below during the staking period:{' '}
                </label>
                <input
                    type="number"
                    ...
                    onChange={(eve) => {
                        this.setState({ sprice: Number(eve.target.value) });
                    }}
                />
                <br />
                <br />
                <label>
                    &emsp;&emsp;&emsp;Enter the amount of XTZ you are willing to
                    betAmount for this wager condition:{' '}
                </label>
                <input
                    type="number"
                    className="inputStyle"
                    ...
                    onChange={(eve) => {
                        this.setState({ amount: Number(eve.target.value) });
                    }}
                />
                <br />
                <br />
                ...
                <div align="center">
                    <button
                        ...
                        style={{ 'font-size': '18px', 'border-radius': '4px' }}
                    >
                        Set Wager Order
                    </button>
